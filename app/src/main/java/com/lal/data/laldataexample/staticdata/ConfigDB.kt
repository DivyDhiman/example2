...
// Object contains Database static keys with create commands
object ConfigDB {
    ...
    const val JOB_DATA = "mock_api_repo_table"

    //Music Player Data
    const val KEY_ID = "KEY_ID"


    val CREATING_DB_MOCK_TABLE = ("create table " + JOB_DATA + "( " + KEY_ID + " INTEGER AUTO_INCREMENT PRIMARY KEY," +
